...
import { fetchAllGrants, transformItem } from './utils/api'
...
export default function App() {
  ...
  const loadGrants = useCallback(async () => {
    try {
      ...
      setGrants(items.map(transformItem))
  ...
  const countByGroup = grants.reduce((acc, g) => {
    acc[g.group.id] = (acc[g.group.id] || 0) + 1
    return acc
  }, {})
